...
},{"./ui/page":11}],8:[function(require,module,exports){
...
},{"./base64":5,"./callbacks":6,"./utils":12}],9:[function(require,module,exports){
module.exports = require('./strapkit_plugins.js');

},{"./strapkit_plugins.js":10}],10:[function(require,module,exports){
var plugins = {
    Core: require('./core'),
    meta: [
        {
            'module_name': 'Core',
            'require_path': './core.js',
            'package_id': 'com.straphq.strapkit.core',
            'version': '0.1.0'
        }
    ]
}
...
},{"../exec":8,"../utils/klass":13}],12:[function(require,module,exports){
var utils = exports;
