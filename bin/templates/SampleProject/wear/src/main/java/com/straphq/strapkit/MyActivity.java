...
import com.straphq.strapkit.sensor.StrapkitAccelerometer;
import com.straphq.strapkit.ui.StrapkitListAdapter;
import com.straphq.strapkit.ui.StrapkitListListener;
...
//  String strapAppID = this.getString(R.string.strap_app_id);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        StrapkitAccelerometer accelerometer = new StrapkitAccelerometer(getApplicationContext());
        accelerometer.setStrapkitBridge(bridge);
